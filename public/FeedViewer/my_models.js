...
Ext.define("ActivityType", { extend: "Ext.data.Model",
    ...
    proxy: {
        ...
        api: {
            read: root_path + 'activity_types/sc_read',
            create: root_path + 'activity_types/sc_create',
            update: root_path + 'activity_types/sc_update',
            destroy: root_path + 'activity_types/sc_destroy'
        },
        reader: {
            type: 'json',
            successProperty: 'success',
...
Ext.define("TabConfig", { extend: "Ext.data.Model",
    fields: [],    
    proxy: {
        type: 'ajax',
        ...
        api: {
            read: root_path + 'tab_configs/sc_read',
            create: root_path + 'tab_configs/sc_create',
            update: root_path + 'tab_configs/sc_update',
            destroy: root_path + 'tab_configs/sc_destroy'
        },
        reader: {
            type: 'json',
            successProperty: 'success',
