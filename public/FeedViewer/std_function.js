...
// ---------------------------------------------------------------------
	...
	pb_get_image_lock = function(value, metaData, rec, rowIndex, colIndex, store) {
	   if(typeof(metaData) !== 'undefined'){		
		...
		if (value == 'PTI_MIS') return '<i class="fa fa-hand-scissors fa-2x" style="color:red;"></i>';
		if (value == 'PTI_REQ') return '<i class="fa fa-hand-scissors fa-2x" style="color:orange;"></i>';
